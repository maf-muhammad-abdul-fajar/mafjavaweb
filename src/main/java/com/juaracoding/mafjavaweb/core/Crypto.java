package com.juaracoding.mafjavaweb.core;
...
public class Crypto {
    ...
    private static String defaultKey = "aafd15f414cae52538b479e2089ddec2f06cb58faafd12f6";
    ...
    public static void main(String[] args) {
        ...
        String strToEncrypt = "bamap354";//put text to encrypt in here
